<?php
namespace Views\viewsAuth;
class ViewLogin extends \Views\ViewsBase{
    ...
    function addCSS($css){
        array_push($this->arrCSS,$css);
    }
    function addJS($js){
        array_push($this->arrJS,$js);
    }
...
<header>
        <div class="header_swrap">
            <div class="header_div_logo"><img src="public/img/LogoMrBien-_banner@2x-1.png" alt=""></div>
        </div>
    </header>


    <main class="container main-signin active" id="main-signin">
        <form class="form">
            ...
            <div class="inputForm">
                ...
                <input placeholder="Enter your Password" class="input" type="password" name="password" id="si_password1">
                <span class="span_eye" data-target="si_password1">
    ...
    <main class="container main-signup" id="main-signup">
        <form class="form">
            ...
            <div class="inputForm">
                ...
                <input placeholder="Enter your Password" class="input" name="password" type="password" id="password1">
                <span class="span_eye" data-target="password1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" width="22" height="22">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
            ...
            <div class="inputForm">
                ...
                <input placeholder="Enter your Password" class="input" name="confirmpassword" type="password" id="password2">
                <span class="span_eye" data-target="password2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" width="22" height="22">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
